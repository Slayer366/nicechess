...
void printUsage()
{
  ...
  cerr << " -h" << endl;
  cerr << "      Print this help screen." << endl;
  cerr << " -g   WIDTHxHEIGHT+X+Y         (800x600+0+0)" << endl;
  cerr << "      Set window geometry." << endl;
//  cerr << "    Default: 800x600+0+0" << endl;
  cerr << " -m" << endl;
  cerr << "      Start in maximized mode." << endl;
  cerr << " -f" << endl;
  cerr << "      Start in fullscreen mode." << endl;
  cerr << " -fn  FONT                     (\"" FONT_FILENAME "\")" << endl;
//  cerr << "    Set font file name." << endl;
//  cerr << "      " << endl;
  cerr << " -md  MODEL_DIRECTORY          (\"" MODELS_DIR "\")" << endl;
//  cerr << "    Set model directory." << endl;
//  cerr << "      (\"" MODELS_DIR "\")" << endl;
  cerr << " -bc  BACKGROUND_COLOR         (187 15 97)" << endl;
//  cerr << "    Set background color." << endl;
//  cerr << "    Default: 187 15 97" << endl;
  cerr << " -wsc WHITE_SQUARE_COLOR       (228 2 97)" << endl;
//  cerr << "    Set white square color." << endl;
//  cerr << "    Default: 228 2 97" << endl;
  cerr << " -bsc BLACK_SQUARE_COLOR       (198 60 78)" << endl;
//  cerr << "    Set black square colors." << endl;
//  cerr << "    Default: 198 60 78" << endl;
  cerr << " -wpc WHITE_PIECE_COLOR        (36 29 96)" << endl;
//  cerr << "    Set white piece color." << endl;
//  cerr << "    Default: 36 29 96" << endl;
  cerr << " -bpc BLACK_PIECE_COLOR        (29 67 76)" << endl;
//  cerr << "    Set black piece color." << endl;
//  cerr << "    Default: 29 67 76" << endl;
  cerr << " -wsi WHITE_SQUARES_IMAGE      (\"" WHITE_SQUARES_IMAGE "\")" << endl;
//  cerr << "    Set white square image file." << endl;
//  cerr << "      (\"" WHITE_SQUARES_IMAGE "\")" << endl;
  cerr << " -bsi BLACK_SQUARES_IMAGE      (\"" BLACK_SQUARES_IMAGE "\")" << endl;
//  cerr << "    Set black square image file." << endl;
//  cerr << "      (\"" BLACK_SQUARES_IMAGE "\")" << endl;
  cerr << " -wsm WHITE_MODIFY_COLOR       (none)" << endl;
//  cerr << "    Set white square image modification color." << endl;
//  cerr << "    Default: none" << endl;
  cerr << " -bsm BLACK_MODIFY_COLOR       (none)" << endl;
//  cerr << "    Set black square image modification color." << endl;
  cerr << "      Example: -wsi whitesquare.png -bsi whitesquare.png -bsm 120 50 30" << endl;
  cerr << " -r" << endl;
  cerr << "      Set reflections on." << endl;
  cerr << " -s" << endl;
  cerr << "      Set shadows on." << endl;
  cerr << " -hp" << endl;
  cerr << "      Set highlight piece on." << endl;
  cerr << " -hs" << endl;
  cerr << "      Set highlight square on." << endl;
...
//  cerr << "    Default: Nice" << endl;
//  cerr << "    Set player types." << endl;
  cerr << "      Choices are: Human, Nice and added chess engine names." << endl;
  cerr << " -wpd WHITE_PLAYER_DIFFICULTY  (3)" << endl;
//  cerr << "    Default: 3" << endl;
  cerr << " -bpd BLACK_PLAYER_DIFFICULTY  (3)" << endl;
//  cerr << "    Default: 3" << endl;
//  cerr << "    Set player difficulty." << endl;
  cerr << "      Choices are: 1 - 9" << endl;
  cerr << " -mt  TIME_MS                  (1000)" << endl;
  cerr << "      Set minimum computer move time." << endl;
//  cerr << "    Default: 1000" << endl;
  cerr << endl;
//  cerr << "Colors are in 0xRRGGBB HUE SATURATION VALUE format." << endl;
  cerr << "Colors are in HUE SATURATION VALUE triplet or in 0xRRGGBB format." << endl;
